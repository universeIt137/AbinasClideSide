...
const FDRform = () => {
    ...
    const handleFDRsubmit = (e) => {
        e.preventDefault();
        toast.warning('FDR not implemented');
    }
    ...
    return (
        <div>
            ...
            <div className='xl:w-[1300px] sm:w-[100%] lg:w-[100%] mx-auto mt-5'>
                <div className='text-black border-2 border-secondary border-solid font-bold text-center text-3xl bg-gradient-to-br text-transparent bg-clip-text from-blue-800 via-blue-800 to-blue-300 rounded-lg mx-auto lg:w-[15%] sm:w-[60%] h-[9%] bg-gray-300 shadow-xl'>FDR Form</div>
                <form onSubmit={handleFDRsubmit}>
