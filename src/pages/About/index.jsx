        ...
        <div className='relative'>
            ...
            <div className='xl:w-[1300px] sm:w-[100%] lg:w-[100%] mx-auto mt-10'>
                ...
                <div className='sm:w-[100%] flex sm:flex-col lg:flex-row gap-8 items-center mt-10 lg:justify-center'>
                    <img src={`${aboutUrl}/${about?.aboutImage
                        }`} alt='avater' className='w-[20%] h-[200px]' />
                    <h2 className='md:w-[80%] sl:w-full text-xl sm:text-lg font-medium text-start px-3 text-white'>{about?.description}</h2>
                </div>
            </div>
        </div>
    );
