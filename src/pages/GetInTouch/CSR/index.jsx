    ...
    return (
        <div>
            ...
            <div className='xl:w-[1300px] sm:w-[100%] lg:w-[100%] mx-auto mt-5'>
                ...
                <div className='flex gap-5 justify-center flex-wrap text-center'>
                    {
                        hasCSR ?
                            allCSR?.map((singleCSR, index) => <SingleCSR key={index} singleCSR={singleCSR} />)
                            :
                            <h2 className='text-center text-xl font-semibold text-gray-400 py-[100px]'><span className='text-2xl text-slate-600 font-bold'>No</span> history for Corporate Social Responsibility</h2>
                    }
                </div>
            </div>
        </div>
